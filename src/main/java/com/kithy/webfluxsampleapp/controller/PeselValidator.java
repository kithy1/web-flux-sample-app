...
public class PeselValidator {
    ...
    public static void main(String[] args) {
        PeselValidator peselValidator = new PeselValidator("78");
        System.out.println(peselValidator.getBirthYear());
        System.out.println(peselValidator.getBirthDay());
        System.out.println(peselValidator.getBirthMonth());
    }
}